...
public class DeletionResponseSerializer {
  @NonNls
  ...
  public void serialize( @NotNull DeletionResponse object, @NotNull OutputStream out ) throws IOException {
  ...
  @NotNull
  public DeletionResponse deserialize( @NotNull InputStream in ) throws IOException, VersionException {
    JsonFactory jsonFactory = JacksonSupport.getJsonFactory();

    JsonParser parser = jsonFactory.createJsonParser( in );
    AbstractJacksonSerializer.nextToken( parser, JsonToken.START_OBJECT );

    DeletionResponse deserialized = deserialize( parser );
  ...
  public void serialize( @NotNull JsonGenerator serializeTo, @NotNull DeletionResponse object ) throws IOException, JsonProcessingException {
  ...
  @NotNull
  public DeletionResponse deserialize( @NotNull JsonParser deserializeFrom ) throws VersionException, IOException, JsonProcessingException {
    ...
    return new DeletionResponse( new DocId( id ), new Revision( rev ) );
    ...
    //      AbstractJacksonSerializer.closeObject( deserializeFrom );
    //      return new DeletionResponse( new DeletionResponse.Error( error, reason ) );
    //    }
  }
}
