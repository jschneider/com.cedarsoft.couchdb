 ...
 *
 */
public class RawCouchDocSerializerTest {
  @Test
  public void testWithInner() throws Exception {
    RawCouchDoc doc = new RawCouchDoc( new DocId( "daId" ), new Revision( "daRev" ) );

    RawCouchDocSerializer serializer = new RawCouchDocSerializer();
  ...
  public void testNoRev() throws Exception {
    RawCouchDoc doc = new RawCouchDoc( new DocId( "daId" ) );
